...
namespace TinyBeans.Caching {
    ...
    public static class Extensions {
        ...
        public static IServiceCollection AddTinyCaching(this IServiceCollection services) {
            return services
        ...
        /// <returns>The <see cref="IServiceCollection"/> so that additional calls can be chained.</returns>
        public static IServiceCollection AddTinyCaching(this IServiceCollection services, Action<CachingOptions> options) {
            return services
                .AddSingleton<ICachingSerializer, DefaultCachingSerializer>()
                .AddSingleton<ICachingAspect, DefaultCachingAspect>()
                .Configure<CachingOptions>(options);
        ...
        /// <returns>The <see cref="IServiceCollection"/> so that additional calls can be chained.</returns>
        public static IServiceCollection AddTinyCaching(this IServiceCollection services, IConfigurationSection configurationSection) {
            return services
                .AddSingleton<ICachingSerializer, DefaultCachingSerializer>()
                .AddSingleton<ICachingAspect, DefaultCachingAspect>()
